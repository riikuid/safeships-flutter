...
class SafetyPatrolActionCard extends StatelessWidget {
  final SafetyPatrolCardModel patrol;
  final int userId;
  final VoidCallback onTap;

  const SafetyPatrolActionCard({
    super.key,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: (patrol.status != 'done' && patrol.status != 'rejected')
              ? whiteColor
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  AppHelper.formatDateToString(patrol.deadline!),
                  style: primaryTextStyle.copyWith(
                    color: redLableColor,
                    fontSize: 12,
                    fontWeight: semibold,
